...
```
Required sections (compare against docs/modules/templates/claude_md.md — v2.15.0 slim orchestrator):
...
The v2.15.0 CLAUDE.md references process skills and rules via pointers. Without these, every pointer is a broken reference.
