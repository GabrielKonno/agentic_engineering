...
|-----------|----------|--------------------|
| `docs/modules/templates/` | Document and config blueprints (`.md` files) | Used by the bootstrap prompt to generate project files (CLAUDE.md, project.md, pendencias.md, settings.json, the `scripts/check-agent-frontmatter.mjs` liveness guard). |
