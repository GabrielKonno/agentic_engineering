...
- `templates/` — Document and config templates used at bootstrap (CLAUDE.md, project.md, pendencias.md, settings.json, metrics.md, check-agent-frontmatter.mjs liveness guard)
