...
> This is the v2.34.1 slim orchestrator (~90 lines). Protocol logic lives in process skills, loaded on demand.
...
- To run an approved backlog segment end-to-end, or continuously under an approved admission policy (Level 5, opt-in), run `/autonomous-loop` after `/sprint-proposer`
