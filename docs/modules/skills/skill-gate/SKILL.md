...
**ALWAYS REPORT — ``creation eval: [component] N/2 scenarios passed`` or
``creation eval: N/A — not an `invocation: subagent` agent``. NEVER emit nothing** (`/audit` 2026-09-02 M-50).
